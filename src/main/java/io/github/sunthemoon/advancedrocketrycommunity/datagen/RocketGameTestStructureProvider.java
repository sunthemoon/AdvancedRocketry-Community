...
/** Empty 16x16x16 allocation for isolated transactional rocket GameTests. */
public final class RocketGameTestStructureProvider implements DataProvider {
    private final Path outputPath;

    public RocketGameTestStructureProvider(PackOutput output) {
        outputPath = output.getOutputFolder(PackOutput.Target.DATA_PACK)
                .resolve(AdvancedRocketryCommunity.MOD_ID)
                .resolve("structures/rocket_test.nbt");
    }
    ...
    public String getName() {
        return "ARCE v0.5 rocket GameTest structure";
    }
    ...
    private static byte[] payload() throws IOException {
        ...
        structure.put("size", coordinates(16, 16, 16));
