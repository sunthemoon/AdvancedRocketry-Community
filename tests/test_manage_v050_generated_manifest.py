...
from scripts.manage_v050_generated_manifest import (
    EXPECTED_PATHS,
    GENERATED_ROOT,
    generate,
    render_manifest,
...
class V050GeneratedManifestTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_exact_inventory_is_sorted_and_bounded(self) -> None:
        ...
        self.assertEqual("v0.5.0", manifest["target_version"])
    ...
    def test_invalid_nbt_or_inventory_change_is_rejected(self) -> None:
