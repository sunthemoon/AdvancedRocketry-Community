...
from scripts.manage_v030_generated_manifest import (
    EXPECTED_PATHS,
    GENERATED_ROOT,
    generate,
    render_manifest,
...
class V030GeneratedManifestTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_exact_inventory_is_sorted_and_bounded(self) -> None:
        ...
        self.assertEqual("v0.3.0", manifest["target_version"])
    ...
    def test_missing_or_unexpected_resource_is_rejected(self) -> None:
