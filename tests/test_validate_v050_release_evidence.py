...
from scripts.validate_v050_release_evidence import (
    ROOT,
    _safe_relative,
    validate_v050_release_evidence,
)


class V050ReleaseEvidenceTests(unittest.TestCase):
    ...
    def test_current_artifact_matches_when_available(self) -> None:
        ...
        errors, _ = validate_v050_release_evidence(ROOT, artifact=artifact)
        self.assertEqual([], errors)
